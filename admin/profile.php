                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-title-wrapper">
                            <div class="page-title-box">
                                <h4 class="page-title"> Edit Profile - <?= $author['author_fullname'] ?></h4>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="separate-form" action="../assets/update.php?type=editprofile&id=<?= $author_id ?>&img=<?= $author["author_avatar"] ?>" method="POST" enctype="multipart/form-data">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="row">
