<?php
    ...
    // Get all admin Data
    $stmt = $conn->prepare("SELECT * FROM admin ORDER BY admin_id DESC");
    $stmt->execute();
                    ...
                    <div class="colxl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-title-wrapper">
                            <div class="page-title-box">
                                <h2 class="page-title bold">Admins (<?= $number_of_rows ?>)</h2>
                            ...
                            <div class="breadcrumb-list">
                                <ul>
                                    ...
                                    <li class="breadcrumb-link active">Admins</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table id="myTable" class="table table-styled" style="padding-bottom: 20px;  border:none">
                                            <thead>  
                                                ...
                                                ?>
                                                    <td>
														<div class="checkbox">
															<input value="<?= $row['admin_id'] ?>" id="checkbox<?= $countnum ?>" type="checkbox" name="<?= $row['admin_id'] ?>" onclick="onSelect('<?= $countnum ?>')">
                                                    ...
                                                    <td style="font-weight: bold;">
                                                        <input type="text" style="border:0px;" value="<?= $row['admin_name'] ?>" />
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="relative">
                                                        ...
                                                        <div class="action-option ">
                                                            <ul>
                                                                <li>
                                                                    <a href="javascript:void(0);" onclick="editadmin(<?= $row['admin_id'] ?>)" >
                                                                        <i class="far fa-edit mr-2" aria-hidden="true"></i> Save
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0);" onclick="deleteadmin(<?= $row['admin_id'] ?>)" >
