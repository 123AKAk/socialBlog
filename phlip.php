...
<head>
    ...
    })(window,document,'script','dataLayer','GTM-NHN3M5H');</script>
    <!-- End Google Tag Manager -->
</head>
<body>
    <!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NHN3M5H"
        ...
        $(function () 
        {
            ...
            $.get('https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fmedium.com%2Ffeed%2F%40philipakoda', data, function (response) {
                if (response.status == 'ok') {
                    ...
                    $.each(response.items, function (k, item) {
                        ...
                        display += `<ahref="#" class="btn btn-outline-success" onclick="showSingleBlog(${k})" data-toggle="modal" data-target="#exampleModal">Read More</a>`;
                        display += '</div></div></div>';
                        //return k < 10;
                    });
            ...
            mediumPromise.then(function()
            {
                ...
                for (var i = 0; i < pageCount; i++) {
                    $("#pagin").append(`<li class="page-item"><a style="background:green;" class="page-link" href="#">${(i + 1)}</a></li> `);
                }
