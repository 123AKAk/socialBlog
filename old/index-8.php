...
<!-- Mirrored from demo-noonpost.assiagroupe.net/html/index-8.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Dec 2022 15:19:16 GMT -->
<head>
    <!-- Meta -->
    <meta charset="UTF-8">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <li><a class="dropdown-item active" href="index-8.php">homepage 8 </a></li>
