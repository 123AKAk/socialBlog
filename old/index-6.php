...
<!-- Mirrored from demo-noonpost.assiagroupe.net/html/index-6.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Dec 2022 15:19:16 GMT -->
<head>
    <!-- Meta -->
    <meta charset="UTF-8">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <li><a class="dropdown-item" href="index-4.php">homepage 4 </a></li>
                                        <li><a class="dropdown-item" href="index-5.php">homepage 5 </a></li>
                                        <li><a class="dropdown-item active" href="index-6.php">homepage 6 </a></li>
                        ...
                        <div class="post-card">
                            ...
                            <div class="post-card-content">
                                ...
                                <h5 class="entry-title">
                                    <a href="post.php">Get The Most Out of Iceland With Our 10 Best Travel Tips </a>
                                </h5>
                    ...
                    <div class="slider-item  swiper-slide ">
                        <div class="post-card">
                            ...
                            <div class="post-card-content">
                                ...
                                <h5 class="entry-title">
                                    <a href="post.php">7 Holiday Decor Ideas and Exactly What I Love About </a>
                                </h5>
                    ...
                    <div class="slider-item  swiper-slide">
                        <div class="post-card">
                            ...
                            <div class="post-card-content">
                                ...
                                <h5 class="entry-title">
                                    <a href="post.php">What Are Your Tips for Hosting an Easy Birthday?</a>
                                </h5>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="post-list">
                                        ...
                                        <div class="post-list-content">
                                            ...
                                            <h4 class="entry-title">
                                                <a href="post.php">7 Holiday Decor Ideas and Exactly What I Love About Each One
                                                </a>
                                            </h4>
