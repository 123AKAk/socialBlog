...
<!-- Mirrored from demo-noonpost.assiagroupe.net/html/index-5.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Dec 2022 15:19:16 GMT -->
<head>
    <!-- Meta -->
    <meta charset="UTF-8">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <li><a class="dropdown-item active" href="index-5.php">homepage 5 </a></li>
            ...
            <div class="container-fluid">
                <div class="slider-style5 ">
                    <div class="swiper-wrapper">
                       <!--slider-1-->
                        <div class="slider-item  swiper-slide" style="background-image: url(assets/img/blog/13.jpg);">
                            <div class="container ">
                                <div class="row">
                       ...
                       <!--slider-3-->
                       <div class="slider-item  swiper-slide" style="background-image: url(assets/img/blog/10.jpg);">
                          <div class="container ">
                             <div class="row">
                                <div class="col-lg-8 m-auto">
                                   <div class="slider-item-content">
