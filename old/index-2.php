...
<!-- Mirrored from demo-noonpost.assiagroupe.net/html/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Dec 2022 15:17:32 GMT -->
<head>
    <!-- Meta -->
    <meta charset="UTF-8">
   ...
   <div id="wrapper" class="wrapper">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <li><a class="dropdown-item active" href="index.php">homepage 1 </a></li>
        ...
        <main class="main">
            ...
            <div class="slider-style1">
                ...
                <!--slider-3-->
                <div class="slider-item  swiper-slide" style="background-image: url(assets/img/blog/9.jpg);">
                    <div class="container ">
                        <div class="row">
                            <div class="col-lg-8 m-auto">
                            <div class="slider-item-content">
                                ...
                                <h1 class="entry-title">
                                    <a href="post.php">What Are Your Tips for Hosting an Easy Birthday Party?
                                    </a>
                                </h1>
                                <ul class="entry-meta list-inline">
                                    <li class="post-author-img"><a href="author.php"> <img src="assets/img/author/1.jpg" alt=""></a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-8 m-auto">
                                <div class="slider-item-content">
                                    ...
                                    <h1 class="entry-title">
                                    <a href="post.php">Get Mhe Most Out of Iceland Mith our 10 Travel Mips
                                    </a>
                                    </h1>
                                    <ul class="entry-meta list-inline">
                                    <li class="post-author-img"><a href="author.php"> <img src="assets/img/author/1.jpg" alt=""></a></li>
...
<!-- Mirrored from demo-noonpost.assiagroupe.net/html/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Dec 2022 15:18:31 GMT -->
</html>